...
function ExaminationPage() {
  return (
    <div>
      <PageHeader eyebrow="Examination Skills" title="OSCE-ready examination checklists." subtitle="GALS, respiratory, ENT, abdominal and cardiovascular — what to say, what to do, what it means." />
